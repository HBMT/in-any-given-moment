...
There is a story traditionally associated with \emph{Dhammapada verse 331}\cite{dhp-331}
above, in which \emph{Mara} tries to entice the
...
reflect that the Buddha pointed out: \emph{You continue to suffer because
