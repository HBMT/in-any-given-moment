...
\emph{Giving to and Receiving from Community}\\
~\\
...
\emph{Do not ignore the effect of right action, saying,\\
...
\href{https://www.accesstoinsight.org/tipitaka/sn/sn45/sn45.002.than.html}{\underline{spiritual
friendship}} {[}109{]}. If we are concerned with finding structures that
...
\emph{Whoever is intent on goodness\\
...
\emph{Practising Together and Alone}
...
\href{https://ratanagiri.org.uk/participate/power-porrodge}{\underline{power-porridge}}
{[}110{]} -- then it could lead to disharmony. Within a very short
