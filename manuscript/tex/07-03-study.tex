...
\emph{A master is one who has let go of all craving\\
...
\emph{The Dhamma holds those who uphold it}

\emph{from falling into delusion.}
...
\emph{A New Rendering of the Dhammapada}

Towards the end of the 1990s I embarked on a project of producing a new
rendering of the
\href{https://forestsangha.org/teachings/books/a-dhammapada-for-contemplation?language=English}{\underline{Dhammapada}}
{[}120{]}. As already mentioned, our annual Forest Sangha calendar
...
\href{http://www.tipitaka.net/tipitaka/dhp/}{\underline{Burmese}
\underline{Pitaka} \underline{Association}} {[}121{]}; from Sri Lanka a
...
\href{https://www.accesstoinsight.org/tipitaka/kn/dhp/index.html}{\underline{Ajahn
Thanissaro's and Bhante Buddharakita's}} {[}122{]} versions. For each
verse I looked into the
\href{http://www.tipitaka.net/tipitaka/dhp/index.php}{\underline{Dhammapada
Commentary}} {[}123{]} that is traditionally associated with it. Even
...
Buddha Taught}, by Walpola Rahula. This small volume, along with Ajahn
Sumedho's
\href{https://forestsangha.org/teachings/books/the-four-noble-truths?language=English}{\emph{\underline{Four
Noble Truths}}} {[}124{]}, provide a clear and accessible foundation
...
\href{https://en.wikipedia.org/wiki/Buddhaghosa}{\emph{\underline{Visuddhimagga}}
\underline{by Ven. Buddhaghosa}} {[}125{]}\emph{,} a well-known text
...
\emph{Goal- and Source-Oriented Practice}
...
Just outside this village is
\href{https://www.ampleforth.org.uk/college/}{\underline{Ampleforth
Abbey and College}} {[}126{]} where Ajahn Puñño did most of his
...
book,
\emph{\underline{\href{https://www.eckhartsociety.org/shop/books/way-paradox}{The
Way of Paradox}.}} {[}127{]}
...
\href{https://en.wikipedia.org/wiki/Cataphatic_theology}{\underline{cataphatic
and the apophatic}} {[}128{]}. The former is that expression of
...
finished.' (Ajahn Chah,
\href{https://forestsangha.org/teachings/books/authors/ajahn-chah?language=English}{\underline{\emph{The
Collected Teachings},}} {[}129{]}, p 478: Chap. 40, What Is
Contemplation?)
...
Inner Distance}' in
\href{https://www.amaravati.org/dhamma-books/when-everything-is-said-wenn-alles-gesagt-ist/}{\emph{\underline{When
Everything Is Said}}} p 61.) {[}130{]}

\emph{Again I am standing unarmed.}

\emph{Again I am standing paralysed}

\emph{facing your last words.}

\emph{Your open gaze,}

\emph{our vulnerable silence;}

\emph{from farewell to farewell}

\emph{we feel for the inner distance}
...
\emph{Positive and Negative Projection}
