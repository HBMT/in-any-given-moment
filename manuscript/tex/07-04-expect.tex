...
discovered -- thanks to `connected breathing' -- that I had developed a rigid pattern of constriction in my back. I have heard that pushing back one's shoulders and tilting the head upwards is a
...
of some Godwits\cite{godwits} which annually fly many thousands of kilometres from the
