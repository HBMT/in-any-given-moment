= Time in Thailand Coming to an End
...
collected]’, page 233, with the title, _Living with The Cobra_. It is a
...
enlightenment. _Nibbana_ is found in _saṃsara_. Enlightenment and
...
In this way _Nibbana_ and _saṃsara_ are the same._
____
...
monasteriesfootnote:[FIXME:cite forestsangha] would be established. Here
...
Teachings of Ajahn Chah__footnote:[FIXME:cite collected]. Here is my
favourite extract from that dialogue,

[quote, role=quote]
____
__Q:_ I still don’t understand. Is true contemplating
the same as thinking?_

_Tan Ajahn Chah:_ We use thinking as a tool, but the knowing that arises
