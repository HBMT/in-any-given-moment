...
Journey__footnote:[FIXME:cite alert] by Ajahn Munindo_
...
Silence__footnote:[FIXME:cite sound-of-silence]. It was a relief to
...
buffeted by the eight worldly windsfootnote:[FIXME:cite worldly-winds] –
...
Buddha’s discoursefootnote:[FIXME:cite mn-118] on meditation on
