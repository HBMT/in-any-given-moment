...
331__footnote:[FIXME:cite dhp-331] above, in which _Mara_ tries to
...
television set a global TV link-upfootnote:[FIXME:cite satellite] – the
...
removing distracting thoughtsfootnote:[FIXME:cite thoughts]. Also I
would recommend reading what Ajahn Tiradhammo wrote in his book,
__Working with the Five Hindrances__footnote:[FIXME:cite hindrances].
...
beansfootnote:[FIXME:cite beans] to run along the frame which they have
...
diseasefootnote:[FIXME:cite lyme]. As can happen, his condition went
