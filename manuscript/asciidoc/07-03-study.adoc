...
[quote, Dhammapada v.352, role=quote]
____
...
pativedha._) If we consider the practice of Dhamma to be like watering
...
that the Buddha stated his teachings were to be made available to everyone. So with the help of a good friend who knew more about Pali than I did, Thomas Jones, I embarked on a project of producing a new rendering.
...
Thanissaro’s and Bhante Buddharakkhita’sfootnote:[link:https://www.accesstoinsight.org/tipitaka/kn/dhp/index.html[Dhammapada, The Path of Dhamma]]
...
come across these teachings. Sometimes I have expressed the opinion that the
...
which is actually ours onto external objects, is happening much of the time. It is very useful to be aware of this. I perceived that I needed Tan
