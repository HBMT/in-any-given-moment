...
building of Bodhinyanarama Monasteryfootnote:[FIXME:cite
bodhinyanarama].
...
Fathersfootnote:[FIXME:cite desert] by the Trappist monk, Thomas Merton,
...
Auckland Viharafootnote:[FIXME:cite auckland]. After many years and a
huge amount of hard work, the same group went on to purchase and develop
Vimutti Monasteryfootnote:[FIXME:cite vimutti], just south of Auckland.
