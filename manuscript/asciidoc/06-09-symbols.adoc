...
cyclic nature of __samsara__footnote:[FIXME:cite sandakada].
...
‘divine messengersfootnote:[FIXME:cite divine]’ – old age, sickness,
...
__ottappa__footnote:[FIXME:cite hiri]; on the left hand side there is a
...
Great from Greecefootnote:[FIXME:cite greco] forayed into what is now
...
in Motion__footnote:[FIXME:cite cakka]. There were other objects that he
...
Centre on The Hirsel Estatefootnote:[FIXME:cite hirsel]. When I
...
Earl of Homefootnote:[FIXME:cite earl] (pronounced Hewm), Sir Alec
...
produce a rakufootnote:[FIXME:cite raku] style pot to use as the main
