...
possibility of living life as a servantfootnote:[FIXME:cite servant]
...
Chah__footnote:[FIXME:cite collected], there is a talk titled, ‘Not
...
Zwingerfootnote:[FIXME:cite zwinger] that Jutta had helped rebuild after
World War Two. On another occasion it was a treat to walk the
Philosophenwegfootnote:[FIXME:cite philosophenweg] in Heidelberg and
...
their own Philosopher’s Walkfootnote:[FIXME:cite walk], and it was a
...
Valleyfootnote:[FIXME:cite monument] and Joshua Treefootnote:[FIXME:cite
joshua] National Parks. The memories I have of the three or four times I
...
Oklahoma bombingfootnote:[FIXME:cite oklahoma] took place, I happened to
...
leader in incarceratingfootnote:[FIXME:cite incarceration] members of
its population.
...
of some Godwitsfootnote:[FIXME:cite godwits] which annually fly many
